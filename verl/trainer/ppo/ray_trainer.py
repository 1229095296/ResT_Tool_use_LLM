            ...
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("old_log_prob", timing_raw, color="blue"):
                        ...
                        ### If config.token_weight is added, explanation is needed
                        # Get weights: prioritize from tensor_batch; if not available, get from DataProto.batch and convert to torch

                        tw_np = batch.batch["token_weight"]  # numpy
                        token_weight = torch.as_tensor(tw_np, dtype=torch.float32, device=response_masks.device)
