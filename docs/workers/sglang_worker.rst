...
------------------------------------------------------------------------------
SGLang also supports running verl's RAY-based cross-machine inference in IPv4 and IPv6 scenarios. In the script below, we use TP=16 for cross-machine inference. Suppose we have two interconnected machines: node0 with IP NODE0_IP_ADDRESS and node1 with IP NODE1_IP_ADDRESS.
...
.. code-block:: bash
    ...
    Local node IP: NODE0_IP_ADDRESS
    ...
    To add another node to this Ray cluster, run
        ray start --address='NODE0_IP_ADDRESS:6379'
